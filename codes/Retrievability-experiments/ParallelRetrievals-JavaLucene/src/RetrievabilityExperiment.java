...
public class RetrievabilityExperiment {
    ...
    private static final String indexPath = "../../../../../../store/collection/indexed/msmarco-passage.notstored";
    private static final List<String> querySetFiles = Collections.singletonList("../../Azzopardi-Queries/MSMARCO/final-queries/all-queries.json");
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        try (IndexReader indexReader = DirectoryReader.open(FSDirectory.open(Paths.get(indexPath)))) {
            ...
            if (forkJoinPool.isTerminated()) {
                try (FileWriter writer = new FileWriter("../../allrd_counters_MSMARCO.json")) {
                    Gson gson = new Gson();
    ...
    private static void retrieve(String query, EnglishAnalyzer analyzer, IndexSearcher searcher, Map<String, Counter> allRd, String similarityModelName) throws ParseException, IOException {
