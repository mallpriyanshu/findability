...
public class FindabilityExperiment {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        try (IndexReader indexReader = DirectoryReader.open(FSDirectory.open(Paths.get(indexPath)))) {
            ...
            try (ProgressBar pb = new ProgressBar("DFR PL2:", queries.size(), 1, System.err, ProgressBarStyle.ASCII, " docs", 1, true, new DecimalFormat("0.0"), ChronoUnit.SECONDS, 0, Duration.ZERO)) {
            ...
            if (forkJoinPool.isTerminated()) {
                try (FileWriter writer = new FileWriter(String.format("../../WT10g/ranks/fd_ranks_%s.json", similarityModelName))) {
                    Gson gson = new Gson();
